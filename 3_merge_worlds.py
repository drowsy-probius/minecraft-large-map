...
world_dir = os.path.join(current_dir, 'temp-2')
output_mca = os.path.join(current_dir, 'output.mca')

TILE_WIDTH = 600
TILE_HEIGHT = 600
SCALE_FACTOR = 20 / 100

shutil.rmtree(output_mca, ignore_errors=True)
